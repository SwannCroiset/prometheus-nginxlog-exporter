...
image:https://travis-ci.org/SwannCroiset/prometheus-nginxlog-exporter.svg?branch=master[link="https://travis-ci.org/SwannCroiset/prometheus-nginxlog-exporter",Build status]
...
image:https://goreportcard.com/badge/github.com/SwannCroiset/prometheus-nginxlog-exporter[link="https://goreportcard.com/report/github.com/SwannCroiset/prometheus-nginxlog-exporter", Go Report Card]
...
You can find an example unit file for this service https://github.com/SwannCroiset/prometheus-nginxlog-exporter/blob/master/systemd/prometheus-nginxlog-exporter.service[in this repository]. Simply copy the unit file to `/etc/systemd/system`:

    $ wget -O /etc/systemd/system/prometheus-nginxlog-exporter.service https://raw.githubusercontent.com/SwannCroiset/prometheus-nginxlog-exporter/master/systemd/prometheus-nginxlog-exporter.service
